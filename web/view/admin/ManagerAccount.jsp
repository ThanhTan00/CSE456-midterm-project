...
<!--                    <th scope="row"><input type="checkbox" /></th>-->
                    <th scope="row">${i}</th>
                    <td class="tm-product-name">${u.getId()}</td>
                    <td>${u.getName()}</td>
                    <td>${u.getGender()}</td>
                    <td>${u.getPhone()}</td>
                    <td>
                      <a href="manage?mode=profile&id=${u.getId()}" class="tm-product-delete-link">
                        <i class="far fa-edit fa-lg" style="color: #eeeff2;"></i>
                      </a>
                    </td>
                    <td ${sessionScope.account.getIsAdmin()==1?"":"hidden"}>
                        <a href="manage?mode=deleteAccount&id=${c.getId()}" class="tm-product-delete-link">
