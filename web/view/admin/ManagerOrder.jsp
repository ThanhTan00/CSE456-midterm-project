    ...
    <div class="container mt-5">
        ...
        <div class="tm-bg-primary-dark tm-block tm-block-products">
            <ul class="nav nav-tabs nav-fill">
                <li class="nav-item">
                  <a ${nav==1?"class='nav-link active'":"class='nav-link'"}  href="manage?mode=orderManage">All</a>
                </li>
                <li class="nav-item">
                  <a ${nav==2?"class='nav-link active'":"class='nav-link'"} href="manage?mode=filterOrder&items=waiting">Waiting</a>
                </li>
                <li class="nav-item">
                  <a ${nav==3?"class='nav-link active'":"class='nav-link'"} href="manage?mode=filterOrder&items=confirmed">Confirmed</a>
                </li>
                <li class="nav-item">
                  <a ${nav==4?"class='nav-link active'":"class='nav-link'"} href="manage?mode=filterOrder&items=delivering">Delivering</a>
                </li>
                <li class="nav-item">
                  <a ${nav==5?"class='nav-link active'":"class='nav-link'"} href="manage?mode=filterOrder&items=completed">Completed</a>
                </li>
            </ul>
...
<!--                    <th scope="row"><input type="checkbox" /></th>-->
                    ...
                    <td>
                      <a href="manage?mode=orderDetail&id=${o.getId()}" class="tm-product-delete-link">
                        <i class="far fa-edit fa-lg" style="color: #eeeff2;"></i>
                      </a>
                    </td>
                    <td style="${nav==1||nav==5?"display:none":""}">
                        <a href="manage?mode=updateOrderStatus&id=${o.getId()}&status=${o.getOrderStatus()}" class="tm-product-delete-link">
